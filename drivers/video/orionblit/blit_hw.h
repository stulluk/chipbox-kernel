...
enum
{
	BLIT_INTERRUPT_MODE   = (1), //1 Enable, 0 Disable
};
...
typedef struct CSBlit_HW_Device 
{
	...
	u8 			S0ClutEnable;
	//u8 			S0ColorKeyEnable;
	//CSGFXOBJ_Color_t 	S0ColorKeyMin;
	//CSGFXOBJ_Color_t 	S0ColorKeyMax;
	CSGFXOBJ_ColorKeyRGB_t 	S0ColorKeyRGB;
	...
	u8 			S1ClutEnable;
	//u8 			S1ColorKeyEnable;
	//CSGFXOBJ_Color_t 	S1ColorKeyMin;
	//CSGFXOBJ_Color_t 	S1ColorKeyMax;
	CSGFXOBJ_ColorKeyRGB_t 	S1ColorKeyRGB;
	...
	u32 			DTotalLineNum;
	CSGFXOBJ_ColorType_t 	DColorType;
	u32 			DAlpha0Min;
	u32 			DAlpha0Max;
