...
#define USB_ALLOC_URB(_iso_pkts, _memflags)	usb_alloc_urb(_iso_pkts, _memflags)	
#else
#define USB_ALLOC_URB(_iso_pkts, _memflags)	usb_alloc_urb(_iso_pkts)	
#endif


#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,9)
#define USB_SNDDEFCTRL(_dev, _ep)	usb_sndctrlpipe(_dev, _ep)
#else
#define USB_SNDDEFCTRL(_dev, _ep)	usb_snddefctrl(_dev)
#endif
 ...
 */
typedef void (*MGC_pfOtgError)(void* pPrivateData, uint8_t bError);
 ...
 */
typedef void (*MGC_pfOtgState)(void* pPrivateData, uint8_t bState);
 ...
 */
typedef void (*MGC_pfOtgSetSession)(void* pPrivateData, uint8_t bSession);
 ...
 */
typedef void (*MGC_pfOtgSetHost)(void* pPrivateData, uint8_t bHost);
 ...
 */
typedef void (*MGC_pfOtgSetSuspend)(void* pPrivateData, uint8_t bSuspend);
...
typedef struct
{
    ...
    uint8_t bState;
    uint8_t bRequest;
    uint8_t bHnpSupported;
    uint8_t bHnpEnabled;
    uint8_t bSetHnpEnable;
    uint8_t bRejecting;
} MGC_OtgMachine;
 ...
 */
extern uint8_t MGC_OtgMachineInit(MGC_OtgMachine* pMachine, 
				  MGC_OtgServices* pOtgServices);
 ...
 */
extern uint8_t MGC_OtgMachineRootDeviceEnumerated(MGC_OtgMachine* pMachine,
    struct usb_device* pDevice, uint8_t bHasOtgDescriptor,
    uint8_t bSupportsHubs, uint8_t bPortSupportsHnp, 
    uint8_t bOtherPortSupportsHnp);
 ...
 * @see #MGC_OtgMachineInit
 */
extern void MGC_OtgMachineRequest(MGC_OtgMachine* pMachine, 
				  uint8_t bRequest);
