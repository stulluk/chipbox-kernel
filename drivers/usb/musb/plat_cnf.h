...
#ifndef __MGC_CONFIG_H__
#define __MGC_CONFIG_H__
...
#define MGC_DFIFO_TOTAL 	(1 << (MGC_C_RAM_BITS + 2))
...
#define MGC_INT_TX_SZ 		3	/* 64 bytes */
#endif
...
#define MGC_INT_RX_SZ 		3	/* 64 bytes */
#endif
...
#define MGC_DFIFO_ISO_TX 	(MGC_DFIFO_TOTAL - (1 << (MGC_ISO_TX_SZ+4)) - (1 << (MGC_BLK_SZ+3+MGC_BLK_DB)) - (1 << (MGC_CTL_SZ+3)) - ((MGC_C_NUM_EPS - 3) * (1 << (MGC_ALL_SZ+3))))
...
#define MGC_DFIFO_ISO_TX 	(MGC_DFIFO_TOTAL - (1 << (MGC_ISO_TX_SZ+3)) - (1 << (MGC_BLK_SZ+3+MGC_BLK_DB)) - (1 << (MGC_CTL_SZ+3)) - ((MGC_C_NUM_EPS - 3) * (1 << (MGC_ALL_SZ+3))))
#endif
...
#define MGC_DFIFO_ISO_RX 	(MGC_DFIFO_TOTAL - MGC_DFIFO_ISO_TX_SIZE - (1 << (MGC_ISO_RX_SZ+4)) - (1 << (MGC_BLK_SZ+3+MGC_BLK_DB)) - (1 << (MGC_CTL_SZ+3)) - ((MGC_C_NUM_EPS - 3) * (1 << (MGC_ALL_SZ+3))))
...
#define MGC_DFIFO_ISO_RX 	(MGC_DFIFO_TOTAL - MGC_DFIFO_ISO_TX_SIZE - (1 << (MGC_ISO_RX_SZ+3)) - (1 << (MGC_BLK_SZ+3+MGC_BLK_DB)) - (1 << (MGC_CTL_SZ+3)) - ((MGC_C_NUM_EPS - 3) * (1 << (MGC_ALL_SZ+3))))
#endif
...
#define MGC_DFIFO_ALL_COUNT 	(MGC_C_NUM_EPS - ((MGC_DFIFO_ISO_TX < 0) ? 0 : 1) - ((MGC_DFIFO_ISO_RX < 0) ? 0 : 1) - (MGC_DFIFO_BLK_SIZE ? 1 : 0) - 1)
...
/** HDRC */
#define MGC_CONTROLLER_HDRC	1

/** MHDRC */
#define MGC_CONTROLLER_MHDRC	2

/**
 * Board-specific information about a controller
 * @field wType one of the MGC_CONTROLLER_* constants
 ...
 */
extern MGC_LinuxController MGC_aLinuxController[];

#endif	/* __MGC_CONFIG_H__ */
