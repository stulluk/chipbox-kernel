...
#define TTX_PAGE_BUF	(FB1_REGION+0x100000)
...
#define TTX_LINESIZE		42
#define TTX_MAXLINES		16	

typedef struct
{	
	unsigned int	Valid_Lines_num;                     /* bit-field lines  0..31 */
...
#define TVE_ReadRegDev8(base_addr, offset)				\
	readb(base_addr + offset)

#define TVE_ReadRegDev16(base_addr, offset)				\
	readw(base_addr + offset)

#define TVE_ReadRegDev32(base_addr, offset)				\
	readl(base_addr + offset)
