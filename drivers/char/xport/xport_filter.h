...
unsigned int FILTER_BUF_LOW(unsigned int filter_index);
unsigned int FILTER_BUF_UP(unsigned int filter_index);
unsigned int xport_filter_rp(unsigned int filter_index);
unsigned int xport_filter_wp(unsigned int filter_index);
